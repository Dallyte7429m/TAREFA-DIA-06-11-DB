...
<head>
    ...
    <style>
        ...
        .header {
            text-align: center;
            background-color: #f06292; /* Rosa forte para o cabeçalho */
            color: #fff;
            padding: 15px 0;
            margin-bottom: 20px;
            border-radius: 8px;
        ...
        table, th, td {
            border: 1px solid #f06292; /* Bordas rosa */
        }
        ...
        th {
            background-color: #f8bbd0; /* Rosa suave para o cabeçalho da tabela */
        }
        ...
        form input, form textarea, form select {
            ...
            padding: 10px;
            margin: 10px 0;
            border: 1px solid #f06292; /* Bordas rosa para inputs */
            border-radius: 5px;
        ...
        .btn-entrar {
            background-color: #f06292; /* Rosa forte para o botão */
            color: white;
            padding: 10px 20px;
            border: none;
            border-radius: 5px;
        ...
        .btn-entrar:hover {
            background-color: #c2185b; /* Rosa escuro para hover */
        }
    </style>
</head>
<body>
