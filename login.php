...
<head>
    ...
    <style>
        body {
            ...
            margin: 40px;
            background-color: #f8e1f4; /* Cor de fundo rosa suave */
        }

        .header {
            text-align: center;
            background-color: #f36cb4; /* Cor do fundo do cabeçalho em rosa forte */
            color: #fff;
            padding: 15px 0;
            margin-bottom: 20px;
            border-radius: 8px;
        ...
        form input[type="text"], form input[type="email"], form input[type="submit"] {
            ...
            padding: 10px;
            margin: 10px 0;
            border: 1px solid #f36cb4; /* Bordas rosa para os inputs */
            border-radius: 5px;
            box-sizing: border-box;
        }

        form input[type="submit"] {
            background-color: #f36cb4; /* Cor de fundo rosa para o botão */
            color: white; /* Cor do texto branco */
            cursor: pointer;
        }

        form input[type="submit"]:hover {
            background-color: #e0529c; /* Cor do botão ao passar o mouse */
        }

        p.error {
            color: #f44336; /* Cor vermelha para a mensagem de erro */
            text-align: center;
            font-weight: bold;
        }
    </style>
