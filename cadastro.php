...
<head>
    ...
    <style>
        body {
            ...
            margin: 40px;
            background-color: #f7e1f5; /* Cor de fundo em tom rosa */
        }

        .header {
            text-align: center;
            background-color: #d25cd2; /* Cor do fundo do cabeçalho */
            color: #fff;
            padding: 15px 0;
            margin-bottom: 20px;
        }
        ...
        form input[type="text"], form input[type="email"], form input[type="submit"] {
            ...
            padding: 10px;
            margin: 10px 0;
            border: 1px solid #d25cd2; /* Borda rosa para os inputs */
            border-radius: 5px;
            box-sizing: border-box;
        }

        form input[type="submit"] {
            background-color: #d25cd2; /* Cor de fundo rosa para o botão */
        ...
        table, th, td {
            border: 1px solid #d25cd2; /* Borda rosa para a tabela */
            text-align: left;
        }
        ...
        th {
            background-color: #f3d1f6; /* Cor de fundo das células de cabeçalho em rosa claro */
        }
        ...
        .delete-btn {
            color: #d25cd2; /* Cor do link de exclusão em rosa */
            cursor: pointer;
        }
